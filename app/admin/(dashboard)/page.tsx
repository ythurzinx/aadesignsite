...
export default async function DashboardPage() {
  ...
  return (
    <div>
      ...
      <div className="mt-8 rounded-2xl bg-[#07152f] p-7 text-white"><p className="text-xs font-bold uppercase tracking-[0.14em] text-[#62b8ff]">Configuração inicial</p><h2 className="display mt-3 text-3xl font-black uppercase">Suba o logotipo e o showreel</h2><p className="mt-3 max-w-2xl text-sm leading-6 text-white/52">O site já funciona com placeholders elegantes. Em Conteúdo, cadastre os arquivos oficiais para substituir cada área sem mexer no layout.</p><a href="/admin/conteudo" className="button-primary mt-6">Configurar conteúdo</a></div>
    </div>
  );
}
