...
export function ProjectForm({ project }: { project?: Project }) {
  ...
  function muxReady(video: { uploadId: string; assetId: string; playbackId: string; status: "ready" }) {
    setValues((current) => ({ ...current, mux_upload_id: video.uploadId, mux_asset_id: video.assetId, mux_playback_id: video.playbackId, mux_status: video.status, video_url: null }));
  }
