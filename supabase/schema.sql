...
begin
  foreach table_name in array array['site_settings','projects','services','equipment','client_logos','testimonials','behind_scenes','leads']
  loop
...
grant select on public.site_settings, public.projects, public.project_media, public.services, public.equipment, public.client_logos, public.testimonials, public.behind_scenes to anon;
grant select, insert, update, delete on public.site_settings, public.projects, public.project_media, public.services, public.equipment, public.client_logos, public.testimonials, public.behind_scenes, public.leads to authenticated;
