    ...
    <main className="min-h-screen bg-[#03060d]">
      ...
      <article className="shell py-14 sm:py-20">
        ...
        <div className="mt-6 grid gap-8 lg:grid-cols-[1.2fr_.8fr] lg:items-end">
          <h1 className="display text-[clamp(3.7rem,8.8vw,8rem)] font-extrabold uppercase leading-[0.88]">{project.title}</h1>
        ...
        <div className="mt-20 rounded-2xl bg-[linear-gradient(135deg,#155dd7,#0b3476)] p-8 sm:p-12"><p className="display text-[clamp(2.5rem,5.5vw,4.8rem)] font-extrabold uppercase leading-[0.9]">Quer criar algo com essa energia?</p><Link href="/#contato" className="mt-8 inline-flex rounded-full bg-white px-6 py-4 text-xs font-black uppercase tracking-[0.12em] text-[#07152f]">Solicitar orçamento <ArrowUpRight className="ml-2 h-4 w-4" /></Link></div>
      </article>
    </main>
  );
}
